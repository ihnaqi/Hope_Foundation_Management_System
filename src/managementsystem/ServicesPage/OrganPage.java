 ...
 * @author Hope
 */
public class OrganPage extends javax.swing.JFrame {
	...
	/**
	 * Creates new form OrganPage
	 */
	public OrganPage() {
		initComponents();
		
	}
	public OrganPage(String currentUser){
		initComponents();
		this.setLocationRelativeTo(null);
		this.currentUser=currentUser;
		organTable.getTableHeader().setBackground(new java.awt.Color(200,102,96));
		organTable.getTableHeader().setForeground(new java.awt.Color(255,255,255));
		organTable.getTableHeader().setOpaque(false);
	...
	public void FeedTheTable(){
		...
		try{
			...
			while( rSet.next()){
				...
				supplierName=rSet.getString(3);
				isAvailable=Math.random()>0.5 ? true: false;
				
				model.insertRow(organTable.getRowCount(), new Object[]{serialNumber, name, supplierName, isAvailable});
			}
		}
    ...
    private void initComponents() {
        ...
        organTable.setFont(new java.awt.Font("Trebuchet MS", 3, 14)); // NOI18N
        organTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Serial Number", "Organ Name", "Supplier Name", "Available"
            }
        ) {
        ...
        organTable.setFocusable(false);
        organTable.setSelectionBackground(new java.awt.Color(0, 0, 204));
        organTable.setShowHorizontalLines(false);
        organTable.setShowVerticalLines(false);
        organTable.getTableHeader().setReorderingAllowed(false);
    ...
    private void minimizeButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minimizeButtonMouseClicked
        ...
        this.setState(OrganPage.ICONIFIED);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(OrganPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
