 ...
 * @author Hope
 */
public class WaterPlantsPage extends javax.swing.JFrame {
	private String currentUser;

	/**
	 * Creates new form WaterPlantsPage
	 */
	public WaterPlantsPage() {
		initComponents();
	}
	public WaterPlantsPage(String currentUser){
		initComponents();
		this.currentUser=currentUser;
		this.setLocationRelativeTo(null);
		waterTable.getTableHeader().setBackground(new java.awt.Color(200,199,201));
		waterTable.getTableHeader().setForeground(new java.awt.Color(255,255,255));
		waterTable.getTableHeader().setOpaque(false);
	...
	public void FeedTheTable(){
		int serialNumber=0;
		String name="", address="", closingTime="";
		...
		try{
			...
			DefaultTableModel model=(DefaultTableModel)waterTable.getModel();
			
			while(rSet.next()){
				serialNumber=rSet.getInt(1);
				name=rSet.getString(2);
				address=rSet.getString(3);
				closingTime=rSet.getString(4);
				
				model.insertRow(waterTable.getRowCount(), new Object[]{serialNumber, name, address, closingTime});
			}
		}
    ...
    private void initComponents() {
        ...
        waterTable.setFont(new java.awt.Font("Trebuchet MS", 3, 14)); // NOI18N
        waterTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Serial Number", "Name", "Address", "Closing Time"
            }
        ) {
        ...
        waterTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        waterTable.setFocusable(false);
        waterTable.setSelectionBackground(new java.awt.Color(0, 0, 204));
        waterTable.setShowHorizontalLines(false);
        waterTable.setShowVerticalLines(false);
        waterTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(waterTable);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(WaterPlantsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new WaterPlantsPage().setVisible(true);
			}
		});
	}
