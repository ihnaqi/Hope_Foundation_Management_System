 ...
 * @author Hope
 */
public class AddOrgan extends javax.swing.JFrame {
	...
	/**
	 * Creates new form AddOrgan
	 */
	public AddOrgan(String currentUser) {
		initComponents();
	...
	public boolean searchDatabase(String name){
			...
			try{
				...
				String sql="Select * from OrganStore";
    ...
    private void initComponents() {
        ...
        nameField.setBackground(new java.awt.Color(241, 233, 252));
        ...
        supplierNameField.setBackground(new java.awt.Color(241, 233, 252));
        supplierNameField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        supplierNameField.setForeground(new java.awt.Color(0, 153, 153));
        supplierNameField.setBorder(null);

        phoneNumberField.setBackground(new java.awt.Color(241, 233, 252));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(supplierNameField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        this.setState(AddOrgan.ICONIFIED);
    ...
    private void submitButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitButtonMouseClicked
        // TODO add your handling code here:
        if(nameField.getText().trim().isEmpty() || supplierNameField.getText().trim().isEmpty() || phoneNumberField.getText().trim().isEmpty()){
            ...
            try {
                ...
                String writeToDatabase="insert into OrganStore(OrganName, SupplierName, Phone) values ('"+nameField.getText().trim()+"','"+supplierNameField.getText().trim()+"'"
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(AddOrgan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
