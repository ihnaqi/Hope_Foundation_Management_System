...
public class AddWater extends javax.swing.JFrame {
	 ...
	 */
	public AddWater(String currentUser) {
		initComponents();
	...
	public boolean searchDatabase(String name){
			...
			try{
				...
				String sql="Select * from WaterPlants";
    ...
    private void initComponents() {
        ...
        timeField.setBackground(new java.awt.Color(204, 255, 0));
        timeField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        timeField.setForeground(new java.awt.Color(17, 87, 87));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        this.setState(AddWater.ICONIFIED);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        // TODO add your handling code here:
		if(nameField.getText().trim().isEmpty() || addressField.getText().trim().isEmpty() || timeField.getText().trim().isEmpty()){
			...
			try {		
				...
				String writeToDatabase="insert into WaterPlants(Name, Address, ClosingTime) values ('"+nameField.getText().trim()+"','"+addressField.getText().trim()+"'"
