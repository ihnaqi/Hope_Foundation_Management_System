 ...
 * @author Hope
 */
public class SweetHomes extends javax.swing.JFrame {
	...
	/**
	 * Creates new form SweetHomes
	 */
	public SweetHomes(String currentUser) {
		initComponents();
	...
	public boolean SearchDatabase(String name){
		...
		try{
			...
			String sql="Select * from SweetHouse";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, 150, 400));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        this.setState(SweetHomes.ICONIFIED);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if(nameField.getText().trim().isEmpty() || addressField.getText().trim().isEmpty() || capacityField.getText().trim().isEmpty()){
            ...
            try {
                ...
                String writeToDatabase="insert into SweetHouse(Name, Address, Capacity, Phone) values ('"+nameField.getText().trim()+"','"+addressField.getText().trim()+"'"
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SweetHomes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
