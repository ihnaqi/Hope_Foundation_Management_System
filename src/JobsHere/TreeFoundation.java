 ...
 * @author Hope
 */
public class TreeFoundation extends javax.swing.JFrame {
	...
	/**
	 * Creates new form TreeFoundation
	 */
	public TreeFoundation(String currentUser) {
		initComponents();
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if(nameField.getText().trim().isEmpty() || addressField.getText().trim().isEmpty() || capacityField.getText().trim().isEmpty()){
            ...
            try {
                ...
                String writeToDatabase="insert into PlantATree(Name, Address, Capacity) values ('"+nameField.getText().trim()+"','"+addressField.getText().trim()+"'"
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        this.setState(TreeFoundation.ICONIFIED);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TreeFoundation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
