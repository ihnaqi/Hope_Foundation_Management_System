...
public class AddNurse extends javax.swing.JFrame {
	 ...
	 */
	public AddNurse(String currentUser) {
		initComponents();
    ...
    private void initComponents() {
        ...
        jLabel16.setText("capable of walikng with us in the most ");

        jLabel17.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(0, 153, 153));
        jLabel17.setText("We have Lord who is capable of crying with us, ");

        jLabel19.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(0, 153, 153));
        jLabel19.setText("difficult memories of life.");

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PersonalitesImages/PopeFrancis.png"))); // NOI18N
        jLabel10.setToolTipText("Pope Francis");
        ...
        nameField.setForeground(new java.awt.Color(184, 248, 248));
        ...
        specializationField.setBackground(new java.awt.Color(153, 153, 255));
        specializationField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        specializationField.setForeground(new java.awt.Color(184, 248, 248));
        specializationField.setBorder(null);

        hospitalField.setBackground(new java.awt.Color(153, 153, 255));
        hospitalField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        hospitalField.setForeground(new java.awt.Color(184, 248, 248));
        hospitalField.setBorder(null);

        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/JobsHere/AdminImages/icons8_user_20px.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/JobsHere/AdminImages/icons8_diploma_20px.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/JobsHere/AdminImages/icons8_hospital_3_20px.png"))); // NOI18N
        ...
        submitButton.setBackground(new java.awt.Color(102, 102, 0));
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addComponent(hospitalField, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(specializationField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGap(24, 24, 24)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(hospitalField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4.setBackground(new java.awt.Color(249, 242, 231));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        this.setState(AddNurse.ICONIFIED);
    }//GEN-LAST:event_jLabel5MouseClicked

    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        // TODO add your handling code here:
		if(nameField.getText().trim().isEmpty() || specializationField.getText().trim().isEmpty() || hospitalField.getText().trim().isEmpty()){
			JOptionPane.showMessageDialog(null, "Please fill all the fields!");
		}
		else if(searchDatabase(nameField.getText().trim())){
			JOptionPane.showMessageDialog(null, "Alreday exit!");
		}
		else if(!searchDatabase(nameField.getText().trim())){
			try {		
				Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
				this.con=DriverManager.getConnection("jdbc:ucanaccess://CareDatabase.accdb");
				String writeToDatabase="insert into Nurses(Name, Specialization, Hospital) values ('"+nameField.getText().trim()+"','"+specializationField.getText().trim()+"'"
