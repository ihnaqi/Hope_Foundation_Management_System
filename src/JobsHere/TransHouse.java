 ...
 * @author Hope
 */
public class TransHouse extends javax.swing.JFrame {
	...
	/**
	 * Creates new form TransHouse
	 */
	public TransHouse(String currentUser) {
		initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Care Transgender Community Houses");
        setUndecorated(true);
        ...
        jLabel16.setText("grief.");

        jLabel17.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(0, 153, 153));
        jLabel17.setText("There is no pain so great as the of joy in present");

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PersonalitesImages/Aeschylus.png"))); // NOI18N
        jLabel10.setToolTipText("Aeschylus");
        ...
        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 30, 340, 400));
        ...
        nameField.setBackground(new java.awt.Color(204, 255, 0));
        nameField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        nameField.setForeground(new java.awt.Color(17, 87, 87));
        ...
        addressField.setBackground(new java.awt.Color(204, 255, 0));
        addressField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        addressField.setForeground(new java.awt.Color(17, 87, 87));
        addressField.setBorder(null);

        capacityField.setBackground(new java.awt.Color(204, 255, 0));
        capacityField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        capacityField.setForeground(new java.awt.Color(17, 87, 87));
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/JobsHere/AdminImages/icons8_clock_20px.png"))); // NOI18N
        ...
        submitButton.setBackground(new java.awt.Color(0, 51, 0));
        ...
        phoneNumberField.setBackground(new java.awt.Color(204, 255, 0));
        phoneNumberField.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        phoneNumberField.setForeground(new java.awt.Color(17, 87, 87));
        phoneNumberField.setBorder(null);

        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/JobsHere/AdminImages/icons8_phone_20px.png"))); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(capacityField, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(capacityField, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 30, 220, 400));
        ...
        jLabel1.setForeground(new java.awt.Color(149, 247, 247));
        jLabel1.setText("Name");

        jLabel2.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(149, 247, 247));
        jLabel2.setText("Address");

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(149, 247, 247));
        jLabel3.setText("Capacity");

        jLabel12.setFont(new java.awt.Font("Trebuchet MS", 1, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(149, 247, 247));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, 150, 400));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 80, 430));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        this.setState(TransHouse.ICONIFIED);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        // TODO add your handling code here:
        if(nameField.getText().trim().isEmpty() || addressField.getText().trim().isEmpty() || capacityField.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(null,"All the fileds should be filled properly.");
        }
        else if(SearchDatabase(nameField.getText().trim())){
            ...
            try {
                ...
                String writeToDatabase="insert into TransgenderCommunityHouse(Name, Address, Capacity, Phone) values ('"+nameField.getText().trim()+"','"+addressField.getText().trim()+"'"
                + ",'"+Integer.parseInt(capacityField.getText().trim())+"','"+phoneNumberField.getText().trim()+"')";
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TransHouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
