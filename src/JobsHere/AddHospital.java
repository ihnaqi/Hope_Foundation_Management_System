...
public class AddHospital extends javax.swing.JFrame {
	 ...
	 */
	public AddHospital(String currentUser) {
		initComponents();
	...
	public boolean searchDatabase(String name){
			...
			System.out.println("Boolean value : "+alreadyExist);
		return alreadyExist;
	}
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(249, 252, 235));
        ...
        jPanel2.setBackground(new java.awt.Color(245, 251, 234));
        ...
        jPanel3.setBackground(new java.awt.Color(242, 252, 252));
        ...
        jLabel10.setText("The right to thope is the most powerfull");

        jLabel11.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 153, 153));
        jLabel11.setText("human motivation I know.");

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PersonalitesImages/Aga Khan IV.png"))); // NOI18N
        jLabel12.setToolTipText("Shah Karim Al Hussaini (Aga Khan IV)");
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        this.setState(AddHospital.ICONIFIED);
    ...
    private void submitButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitButtonMouseClicked
		...
		if(nameField.getText().trim().isEmpty() || addressField.getText().trim().isEmpty() || phoneNumberField.getText().trim().isEmpty()){
			...
			try {		
				...
				String writeToDatabase="insert into Hospitals(Name, Address, PhoneNumber) values ('"+nameField.getText().trim()+"','"+addressField.getText().trim()+"'"
